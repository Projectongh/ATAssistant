...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dell\PycharmProjects\AryanTechnicalAssistant'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dell\PycharmProjects\AryanTechnicalAssistant\Scripts\deactivate.nu'
